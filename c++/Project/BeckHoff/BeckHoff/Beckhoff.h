...
public:
	...
	/*函数名:gvm_exec
	/*描述:发送双包cmd
	/*输入:默认functionid1, deviceid1, value1, value2, functionid2, deviceid2, value3, value4,
	/*输出:无
	/*返回:状态码 true, OK; false, Fail
	/*****************************************************/
	int gvm_exec_two(int f1, int d1, double v1, double v2, int f2, int d2, double v3, double v4);
	...
	/*返回:状态码 true, OK; false, Fail
	/*****************************************************/
	int gvm_exec_th(int f1, int d1, double v1, double v2, int f2, int d2, double v3, double v4, int f3, int d3, double v5, double v6);

	/*****************************************************/
	/*函数名:gvm_add_data
	/*描述:添加数据包到data的第index个位置
	/*输入:默认count，functionid, deviceid, value1, value2, 
	/*输出:无
	/*返回:无
	/*****************************************************/
	void gvm_add_data(int index, int funcid, int devicid, double v1, double v2);
