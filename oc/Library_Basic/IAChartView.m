...
//        NSLog(@"----------------00000-------------------------------------------------");
    ...
    [attributes setValue: boldFont
                   forKey: NSFontAttributeName];
    [attributes setValue:[NSColor brownColor] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[1]>0) {
        [attributes setValue:[NSColor orangeColor] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[3]>0 && loadcelldata.markdata[2]>0) {
        ...
        [self DrawPoint:gc CenterPoint:point];
        [attributes setValue:[NSColor purpleColor] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[4]>0 && loadcelldata.markdata[5]>0) {
        ...
        [[NSColor colorWithCalibratedRed:1 green:0.5 blue:0.5 alpha:1] set];
        [attributes setValue:[NSColor colorWithCalibratedRed:1 green:0.5 blue:0.5 alpha:1] forKey:NSForegroundColorAttributeName];
        ...
        [attributes setValue:[NSColor colorWithCalibratedRed:0.5 green:1 blue:0.5 alpha:1] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[6]>0 && loadcelldata.markdata[7]>0) {
        [attributes setValue:[NSColor colorWithCalibratedRed:1 green:0.5 blue:0.5 alpha:1] forKey:NSForegroundColorAttributeName];
    ...
    if ((loadcelldata.markdata[9]-loadcelldata.markdata[3])>0) {
        ...
        [attributes setValue:[NSColor colorWithCalibratedRed:0.5 green:0.5 blue:1 alpha:1] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[9]>0 ) {
        ...
        [attributes setValue:[NSColor cyanColor] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[10]>0) {
        ...
        [self DrawPoint:gc CenterPoint:point];
        [self DrawPoint:gc CenterPoint:point];
        [attributes setValue:[NSColor magentaColor] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[11]>0 && loadcelldata.markdata[12]>0) {
        [attributes setValue:[NSColor colorWithCalibratedRed:0.25 green:0.75 blue:1 alpha:1] forKey:NSForegroundColorAttributeName];
        [self DarwMarkData:gc Index:11 Height:20 NameWidth:172 ValueWidth:50 IndexWidth:22 Attributes:attributes];
        
        [attributes setValue:[NSColor colorWithCalibratedRed:0.7 green:0.25 blue:0.25 alpha:1] forKey:NSForegroundColorAttributeName];
    ...
    if (loadcelldata.markdata[13]>0 && loadcelldata.markdata[14]>0) {
        ...
        [[NSColor yellowColor] set];
        [self DrawPoint:gc CenterPoint:point];
        [attributes setValue:[NSColor yellowColor] forKey:NSForegroundColorAttributeName];
...
-(void)DrawDRulerText:(NSString*)text Rect:(NSPoint)point
{
    ...
    if (bold) {
        ...
        [attributes setValue: currentFont
                       forKey: NSFontAttributeName];
        [attributes setValue: [NSColor blackColor]
                       forKey: NSForegroundColorAttributeName];
    }
...
//    NSString *keynae=[NSString stringWithCString:m_KeyName encoding:NSASCIIStringEncoding];
    ...
    //        return;
    //    }
    switch(loadcelldata.keyindex)
    {
        case 0:viewtitle = @"X";break;
        case 1:viewtitle = @"Y";break;
        case 2:viewtitle = @"O";break;
        case 3:viewtitle = @"JoyStick";break;
        case 4:viewtitle = @"Middle";break;
        case 5:viewtitle = @"Index";break;
            //        default: break;
            
    }

    NSRect bounds = self.bounds;
    NSPoint point=NSMakePoint(bounds.size.width/2, bounds.size.height);
    ...
    [style setAlignment:NSLeftTextAlignment];
    [attributes setValue:style forKey:NSParagraphStyleAttributeName];
    NSSize size=[viewtitle sizeWithAttributes:attributes];
    NSRect rect=NSMakeRect(point.x, point.y-size.height-5, size.width, size.height);
    [viewtitle drawInRect:rect withAttributes:attributes];
    [style release];
    [attributes release];
}
